...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Realm-iOS11.3/Realm.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RealmSwift-iOS11.3/RealmSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftKeychainWrapper-iOS11.3/SwiftKeychainWrapper.framework"
