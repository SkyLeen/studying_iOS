//
//  FriendMessageReloadingOperation.swift
//  myVKApp
//
...
class FriendMessageReloading: Operation {
    
    private let indexPath: IndexPath
    private weak var view: UITableView?
    private var cell: DialogFriendMessagesViewCell?
    
    init(indexPath: IndexPath, view: UITableView, cell: DialogFriendMessagesViewCell) {
